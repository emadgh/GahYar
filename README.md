...
در «ظاهر برنامه»، روی نمونهٔ رنگ اصلی یا تأکیدی کلیک کنید. کالرپیکر با همان تم، فونت Vazirmatn، راست‌چین و مقیاس مؤثر پنجرهٔ تنظیمات باز می‌شود. هنگام جابه‌جایی انتخابگر، رنگ به‌صورت زنده روی خود گاه‌یار پیش‌نمایش داده می‌شود؛ فقط با «تأیید» ذخیره می‌شود و «انصراف»، Escape یا بستن بدون تأیید، رنگ قبلی را برمی‌گرداند. تغییر پوسته به روشن یا تیره، رنگ‌های پیش‌فرض همان پوسته را فعال می‌کند. انتخاب مجدد پوستهٔ فعلی رنگ سفارشی را حفظ می‌کند؛ «بازگردانی رنگ‌ها» فقط رنگ‌ها را بازنشانی می‌کند. بازنشانی همهٔ تنظیمات در «مدیریت برنامه» پس از تأیید انجام می‌شود.
